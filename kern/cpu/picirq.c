 ...
 * it is sufficient to issue this command only to the Master PIC; however if the
 * IRQ came from the Slave PIC, it is necessary to issue the command to both PIC
 * chips.
 */
