...
// 2024 - decide whether to place this as a private member for each CPU or as a
// global for all CPUs?
...
//=================
struct {
  struct spinlock qlock; // TODO: [PROJECT'24.MS1 - #00 GIVENS] [4] LOCKS -
                         // SpinLock to protect all process queues
