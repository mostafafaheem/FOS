...
int allocate_chunk(uint32 *page_directory, uint32 va, uint32 size,
                   uint32 perms);
/*BONUS*/ void calculate_allocated_space(uint32 *page_directory, uint32 sva,
                                         uint32 eva, uint32 *num_tables,
                                         uint32 *num_pages);
/*BONUS*/ uint32 calculate_required_frames(uint32 *page_directory, uint32 sva,
                                           uint32 size);
