...
_main(void)
{
	...
	if (*y != 20) panic("Get():pp Shared Variable is not created or got correctly") ;
	...
	if (*x != 10) panic("Get():ii Shared Variable is not created or got correctly") ;

	*z = *x + *y ;
	if (*z != 30) panic("Get():oo Shared Variable is not created or got correctly") ;
